\chapterNote{Compreender as dinâmicas}

\chapter{Observar o Mundo}

\tocChapterNote{Compreender as dinâmicas}
...
organização é resumida em `nome' (\emph{nama}).\pagenote{``\thinspace `Nome' ou
  `Mentalidade' é composto por sensação (\emph{vedanā}), percepção
  (\emph{sañña}), intenção/volição (\emph{cetanā}), impressão (\emph{phassa}),
  atenção (\emph{manasikārā}).''\\
  \href{https://suttacentral.net/mn9/en/bodhi}{MN~9.54};
  \href{https://suttacentral.net/sn12.2/en/bodhi}{SN 12.2}}
...
reagimos ao mundo.\pagenote{A origem e a cessação do mundo:
...
atingimos o fim do nosso mundo.\pagenote{\ldots{} não atinge o final das suas
  ...
  ``\ldots{} digo que sem ter atingido o final do mundo não existe forma de
  colocar um fim ao sofrimento.

  Amigo, é precisamente neste mesmo corpo, dotado
  de percepção e de mente que eu torno conhecidos o mundo, a origem do mundo, a
  cessação do mundo e o meio que leva à cessação do mundo.''
  \href{https://suttacentral.net/sn2.26/en/sujato}{SN 2.26};
  \href{https://suttacentral.net/an4.45/en/thanissaro}{AN 4.45}}
...
\subsection{Tendências latentes}
...
antecede a nossa personalidade. Até um bebé tem isto.\pagenote{``\ldots{} um
  delicado bebé deitado de bruços nem sequer tem a noção de
  `personalidade', por isso como é que a noção de personalidade
...
de acordo com o Dhamma (\emph{dhammatā}).\pagenote{Um exemplo de \emph{dhammatā}
  ...
  \href{https://suttacentral.net/an7.65/en/sujato}{AN 7.61}.
