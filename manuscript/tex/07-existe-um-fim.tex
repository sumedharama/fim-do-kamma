\chapterNote{Auto-reflexão}

\chapter{Existe um Fim?}

\tocChapterNote{Auto-reflexão}
...
e pouco inspiradoras. 

Para além disso, o processo contínuo da meditação expõe
...
somos iluminados, meio"-iluminados ou a caminho de lá chegar. 
...
mesma linha.\pagenote{``Então, sabendo de que forma, vendo de que forma,
  ...
  sujeito à mudança.' Esta opinião eternalista é um
  \emph{saṅkhāra} \ldots{} Ou\ldots{} podem ter uma opinião como a seguinte:
  `Eu talvez não exista, nem aquilo que é meu'.
